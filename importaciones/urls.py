...
urlpatterns = [
    path('importaciones/guardar_filtro', views.guardar_datos_filtro, name='guardar_filtro'),
    path('importaciones/lista_productos', views.recibir_datos_planificador, name='lista_productos'),
    path('importaciones', views.importaciones, name='importaciones'),
    path('importaciones/anadir_importacion', views.anadir_importacion, name='anadir_importacion'),
    path('importaciones/importacion/<str:importacion>', views.importacion, name='importacion'),

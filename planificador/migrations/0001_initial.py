    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="planificador.destination_charges",
                    ),
                ),
                (
                    "freight",
                    models.ForeignKey(
                        ...
                        to="planificador.airfreight_charges",
                    ),
                ),
            ],
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "gastos_generales",
                    models.ManyToManyField(to="planificador.Gastos_generales"),
                ),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "tipo_cambio",
                    models.CharField(default="CLP", max_length=128, null=True),
                ),
                ...
                (
                    ...
                    models.ManyToManyField(to="planificador.Presupuesto_subclases"),
                ),
                (
                    "productos",
                    models.ManyToManyField(
                ...
                (
                    "relacion_gastos",
                    models.ManyToManyField(to="planificador.Relacion_gastos"),
                ),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "contactos_asociados",
                    models.ManyToManyField(to="planificador.Contacto"),
                ),
                ("productos_no", models.ManyToManyField(to="planificador.Producto")),
                (
                    "subclases_asociadas",
                    models.ManyToManyField(to="planificador.SubClase"),
                ),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "planilla",
                    models.FileField(max_length=255, null=True, upload_to="img"),
                ),
                ...
                (
                    ...
                    models.ForeignKey(
                        null=True,
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="cotizacion_hija",
                        to="planificador.cotizacion",
                    ),
                ),
                (
                    "cotizacion_padre",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "productos",
                    models.ManyToManyField(
                        related_name="productos_importacion",
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                ...
                to="planificador.origin_charges",
            ),
        ),
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                related_name="productos_asociados", to="planificador.Producto"
            ),
        ),
        migrations.AddField(
            model_name="cotizacion",

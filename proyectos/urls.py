...
urlpatterns = [
    ...
    path('consolidar_proyecto/<str:id>', views.consolidar_proyecto, name='consolidar_proyecto'),
    ...
    path('proyectos/editar_disponibilidad/<str:id>', views.editar_disponibilidad, name='editar_disponibilidad'),

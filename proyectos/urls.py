...
urlpatterns = [
    ...
    path('proyectos/agregar_producto/guardar_datos_filtro_agregar_proyecto', views.guardar_datos_filtro_agregar_proyecto, name='guardar_datos_filtro_agregar_proyecto'),
    path('lista_productos_agregar', views.recibir_datos_agregar_producto, name='lista_productos_agregar'),
